    ...
    switch (selectOption) {
      ...
      case "Robust Admin Template":
        $(e.target)
          ...
          .find(".invoice-item-desc")
          .val(
            "Robust back is super flexible, powerful, clean & modern responsive bootstrap back template with unlimited possibilities"
          );
        break;
      case "Apex Admin Template":
        $(e.target)
          .closest(".invoice-item-filed")
          .find(".invoice-item-desc")
          .val("Developer friendly and highly customizable Angular 7+ jQuery Free Bootstrap 4 gradient ui back template. ");
        break;
      case "Modern Admin Template":
        $(e.target)
          .closest(".invoice-item-filed")
          .find(".invoice-item-desc")
          .val("The most complete & feature packed bootstrap 4 back template of 2019!");
        break;
    }
  });
  // print button
